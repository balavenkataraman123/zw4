...
var physicsObjects = [];
var lastPOsize = 0;
// idea to speed up collision detection:
// have one Map for all the kinematic PO's that stays constant and is only regenerated when needed
// then have another Map for all the non-kinematic ones which is regenerated every frame
